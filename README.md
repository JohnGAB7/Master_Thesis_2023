# Mémoire de Master en Science Actuarielles
...
# IMPACT DE L'AUTOCALIBRATION DANS LA TARIFICATION EN ASSURANCE : Analyse de la déviance et de la courbe de lift
...
importance <- summary(GBM, n.trees = nb.trees.fin)
```
